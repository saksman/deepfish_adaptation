...
class SegWrapper(torch.nn.Module):
    ...
    def loss_calc(pred, label, gpu):
        ...
        criterion = ut.CrossEntropy2d().cuda(gpu)
    ...
    def vis_on_loader_no_gt_mask(self, vis_loader, savedir):
        return wrappers.vis_on_loader_no_gt_mask(self, vis_loader, savedir=savedir)
    
    def train_on_loader(self, model, train_loader, val_loader, domain_adaptation, sampling_strategy, n=None):
